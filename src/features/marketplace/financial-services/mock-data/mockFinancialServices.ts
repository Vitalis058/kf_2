...
export const mockFinancialServices: FinancialService[] = [
  {
    ...
    description:
      "Comprehensive funding solution for early-stage startups with flexible terms and mentorship support.",
    category: "Operations",
    industry: "Technology",
  ...
  },
  {
    ...
    description:
      "Tailored financing for established SMEs looking to expand operations and increase market presence.",
    category: "Growth",
    ...
    customFields: {
      ...
      Cost: 3.2,
      Steps:
        "Application → Assessment → Approval → Documentation → Disbursement",
      TermsOfService: "Standard ADCB SME terms",
      RequiredDocuments:
        "Financial statements, business license, bank statements",
      RelatedServices: [
  ...
  },
  {
    ...
    description:
      "Non-repayable grants for innovative projects in technology, healthcare, and sustainability sectors.",
    category: "Projects",
    industry: "Innovation",
    ...
    customFields: {
      ...
      Cost: 0,
      Steps:
        "Proposal → Evaluation → Selection → Grant Agreement → Disbursement",
  ...
  },
  {
    ...
    description:
      "Specialized financing for UAE companies looking to expand internationally with export credit insurance.",
    category: "Growth",
    industry: "Services",
    ...
    customFields: {
      ...
      Cost: 2.8,
      Steps:
        "Application → Contract Review → Insurance → Approval → Disbursement",
      TermsOfService: "Emirates NBD Export Finance terms",
      RequiredDocuments:
        "Export contracts, financial statements, insurance docs",
      RelatedServices: [
  ...
  },
  {
    ...
    description:
      "Flexible financing secured against business assets including equipment, inventory, and receivables.",
    category: "Assets",
    ...
    customFields: {
      ...
      Cost: 3.5,
      Steps:
        "Application → Asset Valuation → Assessment → Approval → Documentation",
  ...
  },
  {
    ...
    description:
      "Strategic equity investments in high-growth potential companies with value-added support.",
    category: "Equity",
    industry: "Technology",
    ...
    customFields: {
      ...
      Cost: 0,
      Steps:
        "Application → Due Diligence → Investment Committee → Agreement → Investment",
      TermsOfService: "Mubadala Equity Investment terms",
      RequiredDocuments:
        "Business plan, financial projections, management profiles",
      RelatedServices: [
  ...
  },
  {
    ...
    description:
      "Flexible credit line for daily business operations with easy access and competitive rates.",
    category: "Operations",
    industry: "Services",
    ...
    customFields: {
      ...
      RequiredDocuments:
        "Bank statements, business license, financial statements",
      RelatedServices: [
  ...
  },
  {
    ...
    description:
      "Specialized financing for large-scale infrastructure and development projects with long-term repayment.",
    category: "Projects",
    industry: "Infrastructure",
    ...
    customFields: {
      ...
      Cost: 4.0,
      Steps:
        "Application → Feasibility → Assessment → Approval → Documentation → Disbursement",
      TermsOfService: "ADIA Project Finance terms",
      RequiredDocuments:
        "Feasibility study, project docs, environmental assessment",
      RelatedServices: [
  ...
  },
  {
    ...
    description:
      "Comprehensive trade finance solutions including letters of credit, guarantees, and supply chain financing.",
    category: "Operations",
    industry: "Manufacturing",
    ...
    customFields: {
      ...
      Cost: 2.9,
      Steps:
        "Application → Contract Review → Documentation → Approval → Execution",
  ...
  },
  {
    ...
    description:
      "Specialized financing for renewable energy projects with favorable terms and environmental benefits.",
    category: "Projects",
    industry: "Energy",
    processingTime: "14-21 business days",
    cost: "2.3% APR",
    ...
    customFields: {
      ...
      Cost: 2.3,
      Steps:
        "Application → Technical Review → Environmental Assessment → Approval → Implementation",
      TermsOfService: "Masdar Green Energy terms",
      RequiredDocuments:
        "Technical specs, environmental impact, energy estimates",
      RelatedServices: [
        {
          id: "20",
  ...
  },
  {
    ...
    description:
      "Dedicated funding for healthcare technology and medical innovation projects with specialized support.",
    category: "Innovation",
    industry: "Healthcare",
    ...
    customFields: {
      ...
      Cost: 3.0,
      Steps:
        "Application → Medical Review → Regulatory Check → Approval → Implementation",
  ...
  },
  {
    ...
    description:
      "Funding for digital transformation initiatives including technology adoption and process automation.",
    category: "Management",
    industry: "Technology",
    ...
    customFields: {
      ...
      Cost: 2.7,
      Steps:
        "Application → Project Review → Technology Assessment → Approval → Implementation",
